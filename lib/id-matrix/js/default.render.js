    ...
    this.sources = {
      ...
      medicare: function () {
        ...
        var template = '' +
          ...
          '       <div>' +
          '         <h5>Card number</h5>' +
          '         <input type="text" name="card-number" data-validator="medicareCard" maxlength="10" class="fc-fieldinput" data-required>' +
          '       </div>' +
          '     </div>' +
          '     <div class="option col-md-50">' +
          '       <div>' +
          ...
          '         <input type="text" name="date-of-expiry" class="fc-fieldinput" maxlength="10" placeholder="MM/YYYY" data-required>' +
          '       </div>' +
          '     </div>' +
          '     <div class="option col-md-33">' +
          '       <div>' +
