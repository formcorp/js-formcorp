    ...
    this.sources = {
      ...
      driversLicense: function () {
        ...
        var template = '' +
          ...
          '         <input type="text" name="number" class="fc-fieldinput" data-required>' +
          '       </div>' +
          '     </div>' +
          '     <div class="option col-md-50">' +
          '       <div>' +
      ...
      medicare: function () {
        ...
        var template = '' +
          ...
          '       <div>' +
          '         <h5>Card number</h5>' +
          '         <input type="text" name="card-number" class="fc-fieldinput" data-required>' +
          '       </div>' +
          '     </div>' +
          '     <div class="option col-md-50">' +
          '       <div>' +
          '         <h5>Reference number</h5>' +
          '         <input type="text" name="reference-number" class="fc-fieldinput" data-required>' +
          '       </div>' +
          '     </div>' +
          '   </div>' +
          '   <div class="row">' +
          ...
          '         <input type="text" name="date-of-expiry" class="fc-fieldinput" placeholder="DD/MM/YYYY" data-required>' +
          '       </div>' +
          '     </div>' +
          '     <div class="option col-md-33">' +
          '       <div>' +
          '         <h5>Middle name on card</h5>' +
          '         <input type="text" name="middle-name-on-card" class="fc-fieldinput">' +
          '       </div>' +
          '     </div>' +
          '     <div class="option col-md-33">' +
          '       <div>' +
      ...
      previousAddresses: function () {
        var template = '' +
          ...
          '         <input type="text" name="previous-address" class="fc-fieldinput" data-required>' +
          '       </div>' +
          '     </div>' +
          '   </div>' +
          ' </div>' +
