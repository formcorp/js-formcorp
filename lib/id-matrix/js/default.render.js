    ...
    this.sources = {
      ...
      medicare: function () {
        ...
        var template = '' +
          ...
          '         <input type="text" name="date-of-expiry" class="fc-fieldinput" maxlength="100" placeholder="DD/MM/YYYY" data-required>' +
          '       </div>' +
          '     </div>' +
          '     <div class="option col-md-33">' +
          '       <div>' +
          ...
          '       <div>' +
          '         <h5>Card colour</h5>' +
          '         <select name="card-colour" class="fc-fieldinput" data-validator="medicareExpiry" maxlength="10" data-required>' +
          '           <option value="">' +
