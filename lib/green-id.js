...
var fcGreenID = (function ($) {
    ...
    var configKeys = {
        ...
        validResponse = function (data, verificationType) {
            return typeof data === 'object' && typeof data.result === 'object' && typeof data.result.sources === 'object' && typeof data.result.sources[verificationType] === 'object';
        },
        ...
        verifyNSWLicense = function (fieldId) {
            ...
            fc.api('greenid/gateway/verify-nsw', postData, 'POST', function (data) {
                ...
                greenIDOptionsContainer.slideUp(500, function () {
                    licenseOptionContainer.addClass('fc-verified');
                });
                
                console.log('seems to be all bueno');
            });
        },
