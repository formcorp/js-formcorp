    ...
    var configKeys = {
        ...
        initGreenId = function () {
          ...
          searchDict = function (rootId) {
            ...
            if (rootId.indexOf(fc.constants.prefixSeparator) >= 0) {
              ...
              if (fc.fieldSchema[tmp.repeatableIterator[0]] !== undefined) {
                tmp.sourceField = fc.getConfig(fc.fieldSchema[tmp.repeatableIterator[0]], 'sourceField');
          ...
          prePopulateFields = function (obj, rootId, rootSchema, updateMap, childField) {
            ...
            for (key in updateMap) {
              if (updateMap.hasOwnProperty(key)) {
                inputId = fc.getConfig(rootSchema, updateMap[key]);
                value = '';
          ...
          callbackFunctions.DriversLicence = function (el) {
            ...
            containerHtml += fc.ui.renderDropdown(stateOption);
            ...
            stateCallbacks = {
              ...
              NSW: function () {
                ...
                helpData += '<img src="' + fc.getCdnUrl() + '/img/greenid/nsw_license_back.png" style="max-width: 40%; float: right;" alt="NSW Drivers License (back)">';
                ...
                html += '</label>';
                html += fc.ui.renderTextfield(fields.licenseCardNumber);
                html += '</div>';
              ...
              VIC: function () {
                ...
                html += '<div class="vic_address_1">' + fc.ui.renderTextfield(fields.address[0]) + '</div>';
                html += '<div class="vic_address_2">' + fc.ui.renderTextfield(fields.address[1]) + '</div>';
                html += '<div class="vic_address_3">' + fc.ui.renderTextfield(fields.address[2]) + '</div>';
                html += '</div>';
              ...
              WA: function () {
                ...
                html += fc.ui.renderTextfield(fields.expiry);
                html += '</div>';
          ...
          callbackFunctions.EmploymentVisaForeignPassport = function (el) {
            ...
            html += fc.ui.renderTextfield(fields.visaNumber);
            html += '</div>';
          ...
          console.log('set up post greenID');
