...
var fcGreenID = (function ($) {
        ...
        registerGreenIDEventListeners = function () {
            ...
            $(fc.jQueryContainer).on('click', '.green-id-verify .fc-btn', function () {
                ...
                if (typeof fcGreenID.currentState === undefined) {
                    console.log('greenID current state not defined.');
                    return false;
                }
    ...
    return {
        ...
        passesValidation: function (fieldId) {
            return this.isVerified(fieldId) || this.hasFailed(fieldId) || this.amountOfAvailableSources(fieldId) === 0;
        },
        ...
        setProgress: function (fieldId, percentage, updateVerified) {
            ...
            if (fieldContainer.length === 0) {
                console.log('field container es no bueno');
                return;
            }
            ...
            if (progressContainer.length === 0) {
                console.log('progress container es no bueno');
                return;
            }
